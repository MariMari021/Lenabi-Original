...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function atualizarCarrinho() {
    ...
    contFavoritosSpan.textContent = carrinhoItens
  ...
  function resetProdutinhos() {
    ...
    produtinhosBtns.forEach((btn) => {
      ...
      const produtoNoCarrinho = carrinhoItens.find(
      ...
      if (produtoNoCarrinho) {
        ...
        const valorInicial = parseInt(
          valorInicialElement.getAttribute("data-valor-inicial")
        );
